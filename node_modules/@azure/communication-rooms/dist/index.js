...
class RoomsClient {
    ...
    async createRoom(options = {}) {
        const repeatabilityRequestId = coreUtil.randomUUID();
    ...
    listRoomsPage(pageSettings_1) {
        return tslib.__asyncGenerator(this, arguments, function* listRoomsPage_1(pageSettings, options = {}) {
    ...
    listRoomsAll() {
        return tslib.__asyncGenerator(this, arguments, function* listRoomsAll_1(options = {}) {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listRoomsPage({}, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    listParticipantsPage(roomId_1, pageSettings_1) {
        return tslib.__asyncGenerator(this, arguments, function* listParticipantsPage_1(roomId, pageSettings, options = {}) {
            if (!pageSettings.continuationToken) {
    ...
    listParticipantsAll(roomId_1) {
        return tslib.__asyncGenerator(this, arguments, function* listParticipantsAll_1(roomId, options = {}) {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listParticipantsPage(roomId, {}, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(page)));
